...
/*   Updated: 2017/07/26 17:49:02 by vafanass         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_ls.h"

static char	get_setuid(struct stat *sb)
{
	char	setuid;
...
static char	get_setgid(struct stat *sb)
{
	char	setgid;
...
static char	get_sticky(struct stat *sb)
{
	char	sticky;
